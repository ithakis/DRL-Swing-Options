#!/bin/bash
# v46: Initialization experiment — add He (Kaiming) and orthogonal (gain) initializations (select via --init_method).
args=(
...
python run.py "${args[@]}" -name "SwingOption_20_v46_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v46_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v46_13" -seed 13
# python run.py "${args[@]}" -name "SwingOption_20_v46_14" -seed 14
