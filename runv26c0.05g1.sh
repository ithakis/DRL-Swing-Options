...
python run.py "${args[@]}" -name "SwingOption_20_v26_g1_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v26_g1_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v26_g1_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v26_g1_14" -seed 14
