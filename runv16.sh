...
args=(
    ...
    -munchausen=1              # Enable Munchausen RL (adds entropy bonus in reward)
    -nstep=1
...
python run.py "${args[@]}" -name "SwingOption_20_v16_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v16_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v16_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v16_14" -seed 14
