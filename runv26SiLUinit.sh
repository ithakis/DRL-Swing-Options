...
python run.py "${args[@]}" -name "SwingOption_20_v26_131k_65kep_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v26_131k_65kep_12" -seed 12 
python run.py "${args[@]}" -name "SwingOption_20_v26_131k_65kep_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v26_131k_65kep_14" -seed 14 
