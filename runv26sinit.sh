...
python run.py "${args[@]}" -name "SwingOption_20_v26sinit_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v26sinit_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v26sinit_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v26sinit_14" -seed 14 &
