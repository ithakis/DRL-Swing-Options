...
python run.py "${args[@]}" -name "SwingOption_20_v33_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v33_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v33_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v33_14" -seed 14
