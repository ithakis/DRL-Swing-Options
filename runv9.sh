...
args=(
    ...
    --noise_anneal_power=0.7   # Exponent tying noise std to epsilon
    ...
    --final_lr_fraction=0.8    # Final learning rate as fraction of initial (decay to 80%)
...
python run.py "${args[@]}" -name "SwingOption_20_v9_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v9_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v9_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v9_14" -seed 14
