...
echo "============================================================"
echo "LSM SWING OPTION PRICER"
echo "============================================================"
echo "Running LSM Swing Option Pricer with monthly contract parameters..."
echo "Parameters match those used in run.sh for RL training comparison"
echo ""
echo "Note: For higher accuracy, increase n_paths in this script"
echo "      For faster execution, decrease n_paths or n_scenarios"
echo ""

python -m src.lsm_swing_pricer "${args[@]}" -name "LSM_MonthlySwing_$(date +%Y%m%d_%H%M%S)"

echo ""
echo "============================================================"
echo "LSM PRICING COMPLETED!"
echo "============================================================"
echo "Results saved in logs/ directory with timestamped filename"
echo "Compare with RL agent results for benchmarking"
