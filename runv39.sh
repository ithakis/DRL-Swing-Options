...
python run.py "${args[@]}" -name "SwingOption_20_v39_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v39_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v39_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v39_14" -seed 14
