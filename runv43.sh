#!/bin/bash
# v43: Pricing test — warmup calibration targets HHK-based Q_T approximation (E[Q_T]/n_rights).
args=(
...
python run.py "${args[@]}" -name "SwingOption_20_v43_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v43_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v43_13" -seed 13
# python run.py "${args[@]}" -name "SwingOption_20_v43_14" -seed 14
