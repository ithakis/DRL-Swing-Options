#!/bin/bash
# v42: Architecture change — profitability-constrained actor (hard gate + STE) + pre-gate exploration noise.
args=(
...
python run.py "${args[@]}" -name "SwingOption_20_v42_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v42_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v42_13" -seed 13
# python run.py "${args[@]}" -name "SwingOption_20_v42_14" -seed 14
