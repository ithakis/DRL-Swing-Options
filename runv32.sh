...
python run.py "${args[@]}" -name "SwingOption_20_v32_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v32_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v32_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v32_14" -seed 14
