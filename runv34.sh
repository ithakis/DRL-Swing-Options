#!/bin/bash
# v34: Pre-squash Gaussian exploration noise schedule.
args=(
    ...
    -noise_floor=0.32     # Minimum pre-squash noise std after decay
...
python run.py "${args[@]}" -name "SwingOption_20_v34_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v34_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v34_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v34_14" -seed 14
