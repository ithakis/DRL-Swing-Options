#!/bin/bash
# v48: v47 baseline (RMSNorm) + HHK simulation improvements (reproducible QMC + stratified jump draws).
args=(
...
python run.py "${args[@]}" -name "SwingOption_20_v48_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v48_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v48_13" -seed 13
# python run.py "${args[@]}" -name "SwingOption_20_v48_14" -seed 14
