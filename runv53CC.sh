...
python run.py "${args[@]}" -name "SwingOption_20_v53CC_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v53CC_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v53CC_13" -seed 13
# python run.py "${args[@]}" -name "SwingOption_20_v53CC_14" -seed 14
# python run.py "${args[@]}" -name "SwingOption_20_v53CC_15" -seed 15
# python run.py "${args[@]}" -name "SwingOption_20_v53CC_16" -seed 16
# python run.py "${args[@]}" -name "SwingOption_20_v53CC_17" -seed 17
# python run.py "${args[@]}" -name "SwingOption_20_v53CC_18" -seed 18
# python run.py "${args[@]}" -name "SwingOption_20_v53CC_19" -seed 19
