...
args=(
    ...
    -noise_sigma0=1.35         # Slightly higher initial noise to boost early exploration
    -noise_plateau=3500       # Hold initial noise/epsilon longer to avoid early decay
    -noise_floor=0.18    # Lower floor for more late exploitation while avoiding collapse
