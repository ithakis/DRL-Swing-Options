...
args=(
    ...
    --min_action_noise=0.05    # Minimum action noise to avoid zero-variance policies
...
python run.py "${args[@]}" -name "SwingOption_20_v15_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v15_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v15_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v15_14" -seed 14
