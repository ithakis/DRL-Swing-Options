#!/bin/bash
# v55 (relative to v54CC):
# - Same hyperparameters as v54CC.
# - Code change: re-apply profitability gate after target policy noise (target actions now valid).
# - Code change: cost-aware warmup calibration targets raw action mean under convex costs.
# - Metric change: Actions_at_lower_pct now measures near-0 for tanh01/sigmoid outputs.
args=(
...
python run.py "${args[@]}" -name "SwingOption_20_v55_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v55_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v55_13" -seed 13
# python run.py "${args[@]}" -name "SwingOption_20_v55_14" -seed 14
# python run.py "${args[@]}" -name "SwingOption_20_v55_15" -seed 15
# python run.py "${args[@]}" -name "SwingOption_20_v55_16" -seed 16
# python run.py "${args[@]}" -name "SwingOption_20_v55_17" -seed 17
# python run.py "${args[@]}" -name "SwingOption_20_v55_18" -seed 18
# python run.py "${args[@]}" -name "SwingOption_20_v55_19" -seed 19
