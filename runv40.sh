Greetings G
#!/bin/bash
# v39: Faster LR decay horizon and softer late PER to tighten seed-to-seed spread.
args=(
    ...
    -lr_a=2.0e-4                   # Actor LR
    -lr_c=1.1e-4                   # Critic LR
...
python run.py "${args[@]}" -name "SwingOption_20_v40_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v40_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v40_13" -seed 13
# python run.py "${args[@]}" -name "SwingOption_20_v40_14" -seed 14
