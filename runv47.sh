#!/bin/bash
# v47: v43 baseline, but swap LayerNorm -> RMSNorm (--norm=rmsnorm) to test stability/learning dynamics.
args=(
    ...
    --norm=rmsnorm                 # v47: RMSNorm instead of LayerNorm
...
python run.py "${args[@]}" -name "SwingOption_20_v47_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v47_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v47_13" -seed 13
# python run.py "${args[@]}" -name "SwingOption_20_v47_14" -seed 14
