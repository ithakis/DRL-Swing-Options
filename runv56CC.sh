...
#   - Eliminates "gradient cliffs" in high-cost regimes and improves learning stability.
...
#   - Provides a high-quality initial guess that accounts for convex costs (c, gamma).
# - Performance: Recovers profitability in high-cost convex regimes (e.g., c=0.15, gamma=2.0).
...
args=(
    ...
    --c_cost=0.00                # Convex exercise cost coefficient (v56 test case)
    --gamma_cost=1.0             # Convex cost exponent (v56 test case)
...
python run.py "${args[@]}" -name "SwingOption_20_v56EX_11" -seed 11 &
# python run.py "${args[@]}" -name "SwingOption_20_v56EX_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v56EX_13" -seed 13

# python run.py "${args[@]}" -name "SwingOption_20_v56CC_11" -seed 11 --c_cost 0.15 --gamma_cost 2.0 &
# python run.py "${args[@]}" -name "SwingOption_20_v56CC_12" -seed 12 --c_cost 0.15 --gamma_cost 2.0 &
# python run.py "${args[@]}" -name "SwingOption_20_v56CC_13" -seed 13 --c_cost 0.15 --gamma_cost 2.0
