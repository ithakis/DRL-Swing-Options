#!/bin/bash
# v41: Lower initial LRs + 10x smaller warmup std target (0.005) to tighten early variance; keep v40 schedules/other knobs.
args=(
...
python run.py "${args[@]}" -name "SwingOption_20_v41_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v41_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v41_13" -seed 13
# python run.py "${args[@]}" -name "SwingOption_20_v41_14" -seed 14
