#!/bin/bash
# v53 convex cost experiment: c_cost=0.10, gamma_cost=2
args=(
...
python run.py "${args[@]}" -name "SwingOption_20_c0.10_gamma2_11" -seed 11
python run.py "${args[@]}" -name "SwingOption_20_c0.10_gamma2_12" -seed 12
python run.py "${args[@]}" -name "SwingOption_20_c0.10_gamma2_13" -seed 13
python run.py "${args[@]}" -name "SwingOption_20_c0.10_gamma2_14" -seed 14
python run.py "${args[@]}" -name "SwingOption_20_c0.10_gamma2_15" -seed 15

## To activate the correct environment, run:
# cd /Users/alexanderithakis/Documents/GitHub/DRL-Swing-Options && conda activate EP11
# bash SwingOption_20_c0.10_gamma2.sh
