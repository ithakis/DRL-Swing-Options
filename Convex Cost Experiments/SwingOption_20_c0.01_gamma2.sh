#!/bin/bash
# v64 canonical convex-cost experiment: c_cost=0.01, gamma_cost=2
...
args=(
    ...
    --c_cost=0.01              # convex exercise-cost coefficient (this cell)
...
for seed in 11 12 13; do
    python run.py "${args[@]}" -name "SwingOption_20_c0.01_gamma2_${seed}" -seed "$seed" &
    pids+=($!)
done
exit_code=0
