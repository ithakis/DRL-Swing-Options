#!/bin/bash
# v53 convex cost experiment: c_cost=0.02, gamma_cost=1
args=(
...
python run.py "${args[@]}" -name "SwingOption_20_c0.02_gamma1_11" -seed 11
python run.py "${args[@]}" -name "SwingOption_20_c0.02_gamma1_12" -seed 12
python run.py "${args[@]}" -name "SwingOption_20_c0.02_gamma1_13" -seed 13
python run.py "${args[@]}" -name "SwingOption_20_c0.02_gamma1_14" -seed 14
python run.py "${args[@]}" -name "SwingOption_20_c0.02_gamma1_15" -seed 15

## To activate the correct environment, run:
# cd /Users/alexanderithakis/Documents/GitHub/DRL-Swing-Options && conda activate EP11
# bash SwingOption_20_c0.02_gamma1.sh
