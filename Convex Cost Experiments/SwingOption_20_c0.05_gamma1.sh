#!/bin/bash
# Derived from run.sh for convex cost experiment: c_cost=0.05, gamma_cost=1.0
args=(
    -n_paths=32768
    -eval_every=1024
    -n_paths_eval=4096
...
python run.py "${args[@]}" -name "SwingOption_20_v2_c0.05_gamma1_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v2_c0.05_gamma1_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v2_c0.05_gamma1_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v2_c0.05_gamma1_14" -seed 14

# python run.py "${args[@]}" -name "SwingOption_20_c0.05_gamma1_15" -seed 15 &
# python run.py "${args[@]}" -name "SwingOption_20_c0.05_gamma1_16" -seed 16 &
# python run.py "${args[@]}" -name "SwingOption_20_c0.05_gamma1_17" -seed 17 &
# python run.py "${args[@]}" -name "SwingOption_20_c0.05_gamma1_18" -seed 18