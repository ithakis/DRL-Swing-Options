#!/bin/bash
# Derived from run.sh for convex cost experiment: c_cost=0.05, gamma_cost=1.5
args=(
    -n_paths=32768
    -eval_every=1024
    -n_paths_eval=4096
...
python run.py "${args[@]}" -name "SwingOption_20_v2_c0.05_gamma1.5_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v2_c0.05_gamma1.5_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v2_c0.05_gamma1.5_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v2_c0.05_gamma1.5_14" -seed 14

# python run.py "${args[@]}" -name "SwingOption_20_v2_c0.05_gamma1.5_15" -seed 15 &
# python run.py "${args[@]}" -name "SwingOption_20_v2_c0.05_gamma1.5_16" -seed 16 &
# python run.py "${args[@]}" -name "SwingOption_20_v2_c0.05_gamma1.5_17" -seed 17 &
# python run.py "${args[@]}" -name "SwingOption_20_v2_c0.05_gamma1.5_18" -seed 18