Greetings G
#!/bin/bash
# v26s: Same as v26 but with SiLU activations for hidden layers.
args=(
    ...
    --activation=leaky_relu          # Use Leaky ReLU activations for hidden layers
...
python run.py "${args[@]}" -name "SwingOption_20_v26_256k_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v26_256k_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v26_256k_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v26_256k_14" -seed 14 
