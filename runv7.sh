...
python run.py "${args[@]}" -name "SwingOption_20_v7_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v7_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v7_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v7_14" -seed 14
