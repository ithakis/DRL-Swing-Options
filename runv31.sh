...
args=(
    ...
    -noise_sigma0=1.3          # Strong initial noise scale for early exploration
    -noise_plateau=3200       # Hold initial noise/epsilon longer to avoid early decay
    -noise_floor=0.20    # Higher floor to preserve action variance and avoid over-conservative policies
