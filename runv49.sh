#!/bin/bash
# v49: v48 + LAP priorities (Loss-Adjusted Prioritized Experience Replay; Huberized loss-based priorities).
args=(
...
python run.py "${args[@]}" -name "SwingOption_20_v49_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v49_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v49_13" -seed 13
# python run.py "${args[@]}" -name "SwingOption_20_v49_14" -seed 14
