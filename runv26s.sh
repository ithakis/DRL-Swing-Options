...
python run.py "${args[@]}" -name "SwingOption_20_v26s_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v26s_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v26s_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v26s_14" -seed 14 &
