#!/bin/bash
# v24: stronger early action reg, longer warmup, slightly longer plateau/slower decay to boost late delta.
args=(
...
python run.py "${args[@]}" -name "SwingOption_20_v24_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v24_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v24_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v24_14" -seed 14
