#!/bin/bash
# v44: v43 baseline with all clipping removed (no PER priority clipping, no grad clipping, no target-noise clipping arg).
args=(
...
python run.py "${args[@]}" -name "SwingOption_20_v44_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v44_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v44_13" -seed 13
# python run.py "${args[@]}" -name "SwingOption_20_v44_14" -seed 14
