...
args=(
    ...
    --gamma_cost=2           # Convex cost exponent gamma for the per-unit exercise cost term {1.5,2,3}
...
python run.py "${args[@]}" -name "SwingOption_20_v26_g2_11" -seed 11 &
python run.py "${args[@]}" -name "SwingOption_20_v26_g2_12" -seed 12 &
python run.py "${args[@]}" -name "SwingOption_20_v26_g2_13" -seed 13 &
python run.py "${args[@]}" -name "SwingOption_20_v26_g2_14" -seed 14
