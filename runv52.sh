#!/bin/bash
# v52: v51 config (PER/LR/noise/etc tuned while using RMSNorm), but revert RMSNorm -> LayerNorm for stability.
args=(
...
python run.py "${args[@]}" -name "SwingOption_20_v52_265k_11" -seed 11
python run.py "${args[@]}" -name "SwingOption_20_v52_265k_12" -seed 12
python run.py "${args[@]}" -name "SwingOption_20_v52_265k_13" -seed 13
python run.py "${args[@]}" -name "SwingOption_20_v52_265k_14" -seed 14
python run.py "${args[@]}" -name "SwingOption_20_v52_265k_15" -seed 15
python run.py "${args[@]}" -name "SwingOption_20_v52_265k_16" -seed 16
python run.py "${args[@]}" -name "SwingOption_20_v52_265k_17" -seed 17
python run.py "${args[@]}" -name "SwingOption_20_v52_265k_18" -seed 18
python run.py "${args[@]}" -name "SwingOption_20_v52_265k_19" -seed 19
