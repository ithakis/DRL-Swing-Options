...
def run(frames=1000, eval_every=1000, eval_runs=5, worker=1):
    ...
    for frame in range(1, frames+1):
        ...
        for s, a, r, ns, d in zip(state, action, reward, next_state, done):
            experience_batch.append((s, a, r, ns, d))
        
        # Process experiences in batch for better efficiency with multiple workers
        agent.step_batch(experience_batch, frame, writer)
